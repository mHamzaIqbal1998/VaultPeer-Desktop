    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-border-sage px-4 py-3">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden className="text-text-muted">
          ...
          <input
            ...
            autoComplete="off"
          />
          <kbd className="rounded bg-surface-elevated px-1.5 py-0.5 text-[10px] text-text-muted">Esc</kbd>
        </div>
